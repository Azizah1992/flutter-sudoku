...
Color getTextColor(int row, int col, SudokuProblem problem) {
  ...
  color = initialHint ? Color.fromARGB(255, 0, 0, 0) : color;
  return color;
}
...
Color getCellColor(int row, int col) {
  // Color peerCell = Color.fromARGB(255, 255, 255, 255);
  Color background = Color.fromARGB(255, 255, 255, 255);
  // Color peerDigit = Color.fromARGB(255, 193, 129, 129);
  // Color success = CustomStyles.nord14;
  // Color wrong = Color.fromARGB(255, 248, 4, 204);
